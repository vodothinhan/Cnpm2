    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link" href="${pageContext.request.contextPath}/admin/bookManager">Quản lý sách</a>
                </li>
            </ul>
            <a class="btn btn-light me-2" href="${pageContext.request.contextPath}/" role="button">Client</a>
