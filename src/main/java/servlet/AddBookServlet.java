...
@WebServlet(name = "AddBookServlet", urlPatterns = {"/admin/bookManager/addBook"})
@MultipartConfig(
...
public class AddBookServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/views/addBookView.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String successString = "Thêm sách thành công!";
        ...
        if (errorString == null) {
            try {
                DAOFactory.getBookDAO().insert(conn, book);
