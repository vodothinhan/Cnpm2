    ...
    <section class="section-content">
        <div class="container">
            <header class="section-heading py-4 d-flex justify-content-between">
                <h3 class="section-title">Sửa sách</h3>
            </header> <!-- section-heading.// -->
            <main class="add-book-form mb-5">
                <form class="w-50" method="POST" action="${pageContext.request.contextPath}/admin/bookManager/editBook"
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-control bg-light">${book.id}</div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="hidden" name="imageName" value="${book.imageName}">
                    </div>
                    <button type="submit" class="btn btn-primary me-2 mb-3">Sửa sách</button>
